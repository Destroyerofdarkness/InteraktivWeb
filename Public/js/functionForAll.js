...
function closeVideo(id) {
  ...
  // Get the video element by class and pause it
  let videoPlayers = document.getElementsByClassName("Videospiller");
  for (let i = 0; i < videoPlayers.length; i++) {
    videoPlayers[i].pause(); // Pause each video player
  }
}
...
const suggestions = [
  ...
  {
    name: "Sakamoto Days",
    image: "Images/SakamotoDays.jpg",
    action: function () {
      openOverlay("SakamotoDays");
    },
  },
];
